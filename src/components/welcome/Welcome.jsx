      ...
      <div className={`content ${isActive ? 'active' : ''}`}>
        <div className="info">
          ...
          <div className="description">
            ...
            designed especially for mobile and console with revamped controls and streamlined matches.Explore the living
            universe of Runeterra through lore, comics, games, and more. Then dive into the community of gamers,
            cosplayers, musicians, and content creators who are waiting for you to join them.
          </div>
          <div className="btns">
